...
<template>
  <Teleport to="body">
    ...
    <Transition name="dialog-visible" @transitionend="trapFocusDialog">
      <div
        v-if="isVIf" v-show="isVShow" ref="elDialogRoot" aria-modal="true" :aria-labelledby="dialogLabelledBy"
        :style="{
          'z-index': zIndex,
      ...
      >
        ...
        <!-- Mask layer: dimming -->
        <div
          class="dialog-mask absolute inset-0 z-0 bg-black opacity-[0.5] touch-none h-[calc(100%+0.5px)]"
          @click="clickMask"
        />
        <!-- Dialog container -->
        <div class="p-safe-area absolute inset-0 z-1 pointer-events-none opacity-100 flex">
          <div class="flex-1 flex items-center justify-center p-4">
            ...
            <div
              ref="elDialogMain"
              class="dialog-main rounded shadow-lg pointer-events-auto isolate bg-background border-base border-1px border-solid max-w-full  max-h-full of-y-auto overscroll-contain touch-pan-y touch-pan-x"
